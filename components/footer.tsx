...
const socialLinks: { label: string; href: string; color: string; icon: ReactNode }[] = [
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@primehelix.labz",
    color: "#010101", // TikTok primary (black)
    icon: (
  ...
  {
    label: "Discord",
    href: "https://discord.gg/hkSc3XntZH",
              ...
              <div className="flex items-center gap-1">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full text-[var(--brand)] transition-colors duration-200 hover:bg-[color-mix(in_srgb,var(--brand)_10%,transparent)]"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="currentColor"
