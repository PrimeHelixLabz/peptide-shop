...
export function AgeVerification() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
      <div className="flex h-full max-h-screen w-full max-w-lg flex-col rounded-3xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.3)] sm:h-auto sm:max-h-[90vh]">
        {/* Fixed Header at Top */}
        <div className="border-b border-gray-200 bg-white px-4 md:px-6 py-4 sm:px-8 sm:py-6 rounded-t-3xl">
        ...
        <div className="border-t border-gray-200 bg-white px-6 py-4 sm:px-8 sm:py-6 rounded-b-3xl">
